...
class Settings:
	...
	user_settings = [
		{'group': 'camera', 'settings': [
			...
			{'name': 'default_photo_exposure',		'type': 'float',	'range': [0.01,30.0],				'default': 1.0,				'decimalPlaces': 6,	'editable': True,	'displayName': 'Default Photo Exposure',		'description': ''},
			...
			{'name': 'dither_ra',				'type': 'float',	'range': [0.00001,1.0],				'default': 0.001,			'decimalPlaces': 6,	'editable': True,	'displayName': 'Dithering RA Amount',			'description': ''},
			{'name': 'dither_dec',				'type': 'float',	'range': [0.0001,10.0],				'default': 0.01,			'decimalPlaces': 6,	'editable': True,	'displayName': 'Dithering DEC Amount',			'description': ''},
		...
		{'group': 'mount', 'settings': [
			...
			{'name': 'baud',				'type': 'int',		'range': [1200,256000],				'default': 9600,			'decimalPlaces': None,	'editable': True,	'displayName': 'Baud Rate',				'description': ''},
		...
		{'group': 'platesolver', 'settings': [
			...
			{'name': 'search_radius_deg',			'type': 'float',	'range': [0.1, 30.0],				'default': 5.0,				'decimalPlaces': 2,	'editable': True,	'displayName': 'Search Radius(deg)',			'description': ''},
			{'name': 'limit_objs',				'type': 'int',		'range': [10, 10000],				'default': 1002,			'decimalPlaces': None,	'editable': True,	'displayName': 'Limit Results Objects',			'description': ''},
			...
			{'name': 'scale_low_factor',			'type': 'float',	'range': [0.01, 10.0],				'default': 0.1,				'decimalPlaces': 2,	'editable': True,	'displayName': 'Focal Length Low Factor',		'description': ''},
			{'name': 'scale_high_factor',			'type': 'float',	'range': [0.01, 10.0],				'default': 1.25,			'decimalPlaces': 2,	'editable': True,	'displayName': 'Focal Length High Factor',		'description': ''},
